...
function App() {
  ...
  const [email, setEmail] = useState(""); /**const [fname, setFname] = useState("");
...
<form onSubmit={handleSubmit}>
              ...
              <p className="mb-5 " style={{color: '#393f81'}}>Don't have an account? <a href="/sign-up" style={{color: '#393f81'}}>Register here</a></p>
